...
| [aws_iam_role.cluster_eks_iam_role](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role) | resource |
| [aws_iam_role_policy_attachment.cluster_eks_iam_role_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_public_subnet_2a"></a> [public\_subnet\_2a](#input\_public\_subnet\_2a) | Subnet to create EKS cluster AZ 1a | `string` | n/a | yes |
| <a name="input_public_subnet_2b"></a> [public\_subnet\_2b](#input\_public\_subnet\_2b) | Subnet to create EKS cluster AZ 1b | `string` | n/a | yes |
| <a name="input_public_subnet_2c"></a> [public\_subnet\_2c](#input\_public\_subnet\_2c) | Subnet to create EKS cluster AZ 1b | `string` | n/a | yes |
